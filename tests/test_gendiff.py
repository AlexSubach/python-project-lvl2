...
def test_generate_diff_stylish_yml(file1_yml_path, file2_yml_path, result_stylish_yml):
    assert generate_diff(file1_yml_path, file2_yml_path) == result_stylish_yml
